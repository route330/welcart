...
<!--		<table class="settle_table">
	...
	<form action="" method="post" name="anotherlane_form" id="anotherlane_form">
		<table class="settle_table">
			...
			<tr>
				<th><a style="cursor:pointer;" onclick="toggleVisibility('ex_ope_anotherlane');">稼働環境</a></th>
				<td><input name="ope" type="radio" id="ope_anotherlane_1" value="test"<?php if( isset($opts['anotherlane']['ope']) && $opts['anotherlane']['ope'] == 'test' ) echo ' checked="checked"'; ?> /></td><td><label for="ope_anotherlane_1">テスト環境</label></td>
				<td><input name="ope" type="radio" id="ope_anotherlane_2" value="public"<?php if( isset($opts['anotherlane']['ope']) && $opts['anotherlane']['ope'] == 'public' ) echo ' checked="checked"'; ?> /></td><td><label for="ope_anotherlane_2">本番環境</label></td>
				<td><div id="ex_ope_anotherlane" class="explanation"><?php _e('動作環境を切り替えます。', 'usces'); ?></div></td>
			</tr>
			<tr>
