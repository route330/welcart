	...
	***********************************************/
	public function initialize_data() {
		...
		if( !in_array( 'welcart', $options['acting_settings'] ) ) {
			...
			$options['acting_settings']['welcart']['operateid'] = ( isset($options['acting_settings']['welcart']['operateid']) ) ? $options['acting_settings']['welcart']['operateid'] : '';
...
<?php
	...
	***********************************************/
	public function settlement_update() {
		...
		$options['acting_settings']['welcart']['operateid'] = ( isset($_POST['operateid']) ) ? $_POST['operateid'] : '';
	...
	<form action="" method="post" name="welcart_form" id="welcart_form">
		...
		<table class="settle_table">
			...
			<tr class="card_welcart">
				...
				<td><input name="quickpay" type="radio" class="quickpay_welcart" id="quickpay_welcart_1" value="on"<?php if( $acting_opts['quickpay'] == 'on' ) echo ' checked="checked"'; ?> /></td><td><label for="quickpay_welcart_1"><?php _e('Use','usces'); ?></label></td>
				<td><input name="quickpay" type="radio" class="quickpay_welcart" id="quickpay_welcart_0" value="off"<?php if( $acting_opts['quickpay'] == 'off' ) echo ' checked="checked"'; ?> /></td><td><label for="quickpay_welcart_0"><?php _e('Do not Use','usces'); ?></label></td>
				<td></td><td></td>
				<td colspan="2"><div id="ex_quickpay_welcart" class="explanation"><?php _e("Members can pay with saved card. Card number will be registered in e-SCOTT Smart system.",'usces'); ?><?php _e("When using automatic continuing charging (required WCEX DLSeller) or subscription (required WCEX Auto Delivery), please make 'Quick payment' of 'Use'.",'usces'); ?></div></td>
			</tr>
			<tr class="card_chooseable_quickpay_welcart">
				<th><a style="cursor:pointer;" onclick="toggleVisibility('ex_chooseable_quickpay_welcart');"><?php _e('Register credit card','usces');//クレジットカードの登録 ?></a></th>
				<td><input name="chooseable_quickpay" type="radio" class="chooseable_quickpay_welcart" id="chooseable_quickpay_welcart_1" value="on"<?php if( $acting_opts['chooseable_quickpay'] == 'on' ) echo ' checked="checked"'; ?> /></td><td><label for="chooseable_quickpay_welcart_1"><?php _e('Member chooses','usces'); ?></label></td>
				<td><input name="chooseable_quickpay" type="radio" class="chooseable_quickpay_welcart" id="chooseable_quickpay_welcart_0" value="off"<?php if( $acting_opts['chooseable_quickpay'] == 'off' ) echo ' checked="checked"'; ?> /></td><td><label for="chooseable_quickpay_welcart_0"><?php _e('Always register','usces'); ?></label></td>
				<td></td><td></td>
				<td colspan="2"><div id="ex_chooseable_quickpay_welcart" class="explanation"><?php _e("In case of 'Always register', 'Register and purchase credit card' will not be displayed when purchasing with credit card.",'usces'); ?></div></td>
			</tr>
			<tr class="card_welcart">
				<th><a style="cursor:pointer;" onclick="toggleVisibility('ex_operateid_welcart');"><?php _e('Processing classification','usces');//処理区分 ?></a></th>
				...
				<td></td><td></td>
				<td colspan="2"><div id="ex_operateid_welcart" class="explanation"><?php _e("In case of 'Credit' setting, it need to change to 'Sales recorded' manually in later. In case of 'Credit sales recorded' setting, sales will be recorded at the time of purchase.",'usces'); ?></div></td>
			</tr>
